...
PATH_TO_MOVIE_LENS_DATA = "./tud_small_movie_lens_data"


def run_weighted_nmf():
    # Read in two data sets: training set and ratings from interface.
    our_ratings = read_file(f"{PATH_TO_USER_RATINGS}/ratings.csv")
    movielens_ratings = read_file(f"{PATH_TO_MOVIE_LENS_DATA}/ratings.csv")
    ...
    model = rdfnmf_updated.RDFNMFPlus(
